              ...
              <BaseSection>
                <div className="min-h-screen overflow-x-hidden">
                  <div className="md:pt-10 truncate pt-10">
                    ...
                    <div className="max-w-7xl  mx-auto pt-8 md:gap-10 md:flex-row flex-col gap-10 md:gap-20 flex px-5">
                          ...
                          <div className="flex flex-col mt-5">
                            ...
                            <div className="flex flex-col gap-4 pb-7 mt-5">
                              ...
                              <a
                                  target="_blank"
                                  rel="noreferrer"
                                  href={`https://wa.me/8591386693/?text=Hii, Gogreenganesha, %0a %0a I want to order this ${product?.name} murti %0a  https://gogreenganesha.com/clay-ganesha/product?q=${product?.url}`}
                  ...
                  <div className="sm:hidden px-5 flex flex-col gap-3">
                    ...
                    >
                      <button
                          ...
                          } bg-gradient-to-r from-blue-50 to-sky-50  p-4  w-full   flex justify-between text-left cursor-pointer font-semibold text-xl md:text-2xl`}
                      >
                        Description
                      ...
                      {text == "desc" &&
                      <div className="flex flex-col pb-5 px-5 gap-4">
                        {product?.description}
                      </div>
                      }
                    </div>
                      ...
                      {text === "feature" && (
                          <div className="flex flex-col pb-5 px-5">
                            {obj.features.map((item, i) => (
                                <div
                                    key={i}
                                    className="flex flex-col items-center text-center whitespace-nowrap w-full px-10 gap-2 py-4"
                                >
                                  <div>
                                    <img
                      ...
                      {text === "specification" && (
                          <div className=" px-5  pb-5 ">
                            ...
                            <p className="start py-3 text-base md:text-xl">
                              Wrapkit skins are thin textured self adhesive sheets that are precisely cut for your device. Unlike traditional cases and covers, you can stylize your device without adding bulk and keep its form factor. It also protects your devices from scratches and fingerprints, and the texture gives your phone a better grip.
                            </p>
                          </div>
                      )}
                    </div>
