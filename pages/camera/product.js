                      ...
                      <div className="flex w-full flex-col mt-5">
                        ...
                        <div className="flex w-full flex-col gap-4 pb-7 mt-5">
                          ...
                          <a
                            target="_blank"
                            rel="noreferrer"
                            href={`https://wa.me/919421193881/?text=Hii, Wrapkit, %0a %0a I want to order this ${data?.name} %0a  https://wrapkit.in/camera/product?q=${data?.url}`}
