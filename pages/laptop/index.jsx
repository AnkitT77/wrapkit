...
export default function ClayGanesha() {
  ...
  return (
      <div className="pb-24">
        <div className="bg-gradient-to-b from-indigo-50/70 to-violet-100/70 md:pt-[150px] pb-[60px] md:pb-[80px] flex items-center justify-start w-full">
          <div className="max-w-7xl w-full mx-auto">
            <div className="flex flex-col gap-5 max-w-4xl text-center mx-auto px-5">
              ...
              <Paragraph extra="max-w-2xl mx-auto">
                We have a variety of classic designs and materials to choose from. So go ahead and decorate your Laptop with one of our cool printed Laptop Skins.
