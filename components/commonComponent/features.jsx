            ...
            <div className="grid w-full md:grid-cols-2 grid-cols-1 max-w-7xl mx-auto gap-10">
                ...
                >
                    <div className="flex flex-col max-w-md mr-auto w-full gap-4">
                        <Paragraph2 text="Our Wraps Are Made Of <span class='text-blue-600'>High-Quality Vinyl</span>, Which Makes Them Flexible And Long-Lasting" style="text-zinc-800">
                        </Paragraph2>
                    </div>
                ...
                <div className="flex w-full flex-col gap-10">
                    ...
                    >
                        <div className="flex flex-col max-w-md mr-auto  w-full gap-4">
                            <Paragraph2 text=" Our High Performance Skins Are Not Only Great To <span class='text-purple-600'>Prevent Nicks And Scratches</span>, But Also Hide Any Old Ones" style="text-zinc-800">
                            </Paragraph2>
                        </div>
                        <div className="rounded-[15px]  relative h-full w-full">
                    ...
                    >
                        <div className="flex flex-col max-w-md mr-auto w-full gap-4">
                            <Paragraph2 text="We Have A Variety Of <span class='text-[#bd3c32]'>Classic Designs</span> And <span class='text-[#bd3c32]'>Materials</span> To Choose From" style="text-zinc-800">
                            </Paragraph2>
                        </div>
                        <div className="rounded-[15px]  relative h-full w-full">
