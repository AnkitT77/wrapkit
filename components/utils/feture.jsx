...
export function BlurBackground() {
  return (
    <div className="fixed z-30 bg-gray-700 opacity-70 w-full h-full top-0 left-0"></div>
  );
}
...
export const color = [
  ...
  "bg-lime-50 group-hover:bg-lime-100",
...
export const removeUnwantedEntry = (array) => {
  let arr;
