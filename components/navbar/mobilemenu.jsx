            ...
            <ul>
              ...
              >
                <button className="justify-between w-full flex items-center">
                  <h6 className=" text-xl font-semibold">Select Devices</h6>
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`h-5 w-5 transform ${
                        collapseMenu == "device" ? "rotate-180" : ""
                ...
                {collapseMenu == "device" && (
                  <ul className="text-zinc-800 text-[17px] px-5">
                    <li className="py-2 hover:text-indigo-500 duration-100 ease-in  cursor-pointer">
                      <Link href="/phone">
                        <a onClick={() => passclose(false)}>Mobile Phone</a>
                      </Link>
                    </li>
                    <li className="py-2 hover:text-indigo-500 duration-100 ease-in  cursor-pointer">
                      <Link href="/charger">
                        <a onClick={() => passclose(false)}>charger</a>
                      </Link>
                    </li>
                    <li className="py-2 hover:text-indigo-500 duration-100 ease-in  cursor-pointer">
                      <Link href="/laptop">
              ...
              >
                <button className="justify-between w-full flex items-center">
                  <h6 className="text-xl font-semibold">Themes</h6>
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`h-5 w-5 transform ${
                ...
                {collapseMenu == "theme" && (
                  <ul className="px-5 text-[17px]">
                    <li className="py-2 hover:text-indigo-500 duration-100 ease-in  cursor-pointer">
                      <Link href="/phone">
                        <a onClick={() => passclose(false)}>Dark</a>
                      </Link>
                    </li>
                    <li className="py-2 hover:text-indigo-500 duration-100 ease-in  cursor-pointer">
                      <Link href="/phone">
                        <a onClick={() => passclose(false)}>Abstract</a>
                      </Link>
                    </li>
                    <li className="py-2 hover:text-indigo-500 duration-100 ease-in  cursor-pointer">
                      <Link href="/phone">
                        <a onClick={() => passclose(false)}>Tropical Flowers</a>
                      </Link>
                    </li>
                    <li className="py-2 hover:text-indigo-500 duration-100 ease-in  cursor-pointer">
                      <Link href="/phone">
                    ...
                    <li className="py-2 hover:text-indigo-500 duration-100 ease-in  cursor-pointer">
                      <Link href="/phone">
                        <a onClick={() => passclose(false)}>Bright Colors</a>
                      </Link>
                    </li>
                  </ul>
                )}
                ...
                <Link href="https://www.facebook.com/Wrapkit.in?mibexid=ZbWKwL">
                  <a target="_blank" rel="noreferrer">
                    <div className="bg-blue-500 rounded-full w-10 h-10 flex justify-center items-center duration-200">
                      <svg
                        className="group  fill-white  w-6 h-6"
