...
export default function AboutEco() {
  ...
  return (
    <div className="w-full md:py-20 bg-[#F1F6FC] py-14 text-[#184029]">
      <div className="w-full flex flex-col items-center text-center justify-center ">
        <div className="flex w-full  justify-center items-center">
          <div className="flex flex-col text-center justify-center items-center">
            <h2 className="md:text-4xl text-3xl w-full font-bold text-zinc-800 tracking-wider md:text-4xl ">
              Our Features
            </h2>
          </div>
        </div>
      </div>
      <div className="capitalize mt-8 flex flex-col max-w-2xl gap-2  items-center font-body  px-5 mx-auto text-center">
        <p style={{ lineHeight: 1.8 }} className="md:text-xl text-lg">
          Our wraps are made of <span className="wave">high-quality vinyl</span>
          , which makes them both flexible and long-lasting.
        </p>
      </div>
      <div className="flex max-w-6xl px-5 pt-14 md:pt-16 mx-auto w-full  flex-col items-center justify-between sm:flex-row">
        ...
        <div
          ref={observe}
          className="w-full   h-96 flex justify-center md:w-1/2"
        >
          {animatein && (
            <div className="flex h-full flex-col gap-y-5 my-8 md:mx-4 ">
              <h2 className="md:text-3xl text-2xl font-bold font-display tracking-wider">
    ...
    <>
      <div className="flex gap-x-2 items-center">
        <svg
          ...
          className="w-[20px] h-[17px] sm:w-[25px] sm:h-[25px]"
          viewBox="0 0 30 23"
        >
            ...
            <g fill="#72AB00" fillRule="nonzero">
              <g>
                <path
                  ...
                  transform="translate(-686 -7850) translate(686 7850)"
                ></path>
              </g>
            </g>
          </g>
